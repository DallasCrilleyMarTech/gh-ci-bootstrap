...
1. Create repo `DallasCrilleyMarTech/gh-ci-bootstrap` with these files at root.
2. `gh extension install DallasCrilleyMarTech/gh-ci-bootstrap` to sanity check locally.
3. Run `gh ci-bootstrap --dry-run` inside a repo to verify org check and file output.
